...
//        SDKInitializer.initialize(getApplicationContext());，因此我们建议该方法放在Application的初始化方法中
        ...
        place1.setText("开始驾车导航");
        place1.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.skyjaj.hors.baidu.Mylocation.this,BNMainActivity.class));
            }
        });
    ...
    public class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            editor.commit();
            mylocation.setText(location.getLocationDescribe());
