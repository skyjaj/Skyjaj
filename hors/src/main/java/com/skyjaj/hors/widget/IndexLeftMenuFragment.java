 ...
 */
public class IndexLeftMenuFragment extends ListFragment {
    ...
    private IndexLeftMenuAdapter mAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < SIZE_MENU_ITEM; i++) {
            menuItem = new IndexMenuItem(getResources().getStringArray(R.array.index_array_left_menu)[i], false, R.drawable.music_36px, R.drawable.music_36px_light);
            mItems[i] = menuItem;
        }
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        setListAdapter(mAdapter = new IndexLeftMenuAdapter(getActivity(), mItems));
