    ...
    public void processPacket(Packet packet) {
        ...
        if (packet instanceof NotificationIQ) {
            ...
            if (notification.getChildElementXML().contains(
            	...
            	String notificationImgUrl = notification.getImageUrl();
                ...
                history.setImageUrl(notificationImgUrl);
                history.setMessage(notificationMessage);
                history.setUri(notificationUri);
                history.setTitle(notificationTitle);
                SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-mm HH:mm");
                String time =dateFormat.format(new Date());
                history.setTime(time);
                history.save();
                Log.d("TAG", "notification insert the db ");
                //save to db ok
                ...
                intent.putExtra(Constants.NOTIFICATION_IMAGME_URL, notificationImgUrl);
